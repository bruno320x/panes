...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::engines::get_opencode_providers,
            commands::engines::get_opencode_provider_auth,
            commands::engines::set_opencode_provider_auth,
            commands::engines::delete_opencode_provider_auth,
            commands::engines::start_opencode_provider_oauth,
            commands::engines::complete_opencode_provider_oauth,
            commands::engines::get_opencode_config,
            commands::engines::patch_opencode_config,
            ...
            commands::threads::get_opencode_remote_session_detail,
            commands::threads::list_opencode_remote_session_children,
            commands::threads::get_opencode_remote_session_todos,
            commands::threads::get_opencode_remote_session_diff,
            commands::threads::share_opencode_remote_session,
            commands::threads::unshare_opencode_remote_session,
            commands::threads::summarize_opencode_remote_session,
            commands::threads::fork_opencode_remote_session,
            commands::threads::revert_opencode_remote_session,
            commands::threads::unrevert_opencode_remote_session,
            commands::threads::archive_opencode_remote_session,
            commands::threads::unarchive_opencode_remote_session,
            commands::threads::delete_opencode_remote_session,
            ...
            commands::threads::fork_opencode_thread,
            commands::threads::compact_opencode_thread,
